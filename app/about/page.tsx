...
const About = () => {
  ...
  return (
    <section
    id="about" className="flex flex-col items-center w-full min-h-screen px-6 py-16 gap-14 bg-gray-100 ">
      ...
      <div className="max-w-4xl text-lg text-center text-gray-700 leading-relaxed">
        ...
        as backend development with <strong>Laravel</strong>, <strong>PHP</strong>, and <strong>C#</strong>.
